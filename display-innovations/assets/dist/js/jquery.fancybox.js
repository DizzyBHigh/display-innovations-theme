...
!function (e, t, i, n) {
    ...
    i.extend(s, {
        ...
        _setDimension: function () {
            var e, t, n, o, a, r, l, c, d, p, h, u, y, b, w, v = s.getViewport(), x = 0, k = !1, C = !1, O = s.wrap, S = s.skin, T = s.inner, j = s.current, P = j.width, _ = j.height, W = j.minWidth, L = j.minHeight, E = j.maxWidth, M = j.maxHeight, H = j.scrolling, R = j.scrollOutside ? j.scrollbarWidth : 0, A = j.margin, D = g(A[1] + A[3]), I = g(A[0] + A[2]);
            if (O.add(S).add(T).width("auto").height("auto").removeClass("fancybox-tmp"), e = g(S.outerWidth(!0) - S.width()), t = g(S.outerHeight(!0) - S.height()), n = D + e, o = I + t, a = f(P) ? (v.w - n) * g(P) / 100 : P, r = f(_) ? (v.h - o) * g(_) / 100 : _, "iframe" === j.type) {
                if (b = j.content, j.autoHeight && b && 1 === b.data("ready"))try {
                    b[0].contentWindow.document.location && (T.width(a).height(9999), w = b.contents().find("body"), R && w.css("overflow-x", "hidden"), r = w.outerHeight(!0))
                } catch (z) {
                }
            } else(j.autoWidth || j.autoHeight) && (T.addClass("fancybox-tmp"), j.autoWidth || T.width(a), j.autoHeight || T.height(r), j.autoWidth && (a = T.width()), j.autoHeight && (r = T.height()), T.removeClass("fancybox-tmp"));
            if (P = g(a), _ = g(r), d = a / r, W = g(f(W) ? g(W, "w") - n : W), E = g(f(E) ? g(E, "w") - n : E), L = g(f(L) ? g(L, "h") - o : L), M = g(f(M) ? g(M, "h") - o : M), l = E, c = M, j.fitToView && (E = Math.min(v.w - n, E), M = Math.min(v.h - o, M)), u = v.w - D, y = v.h - I, j.aspectRatio ? (P > E && (P = E, _ = g(P / d)), _ > M && (_ = M, P = g(_ * d)), P < W && (P = W, _ = g(P / d)), _ < L && (_ = L, P = g(_ * d))) : (P = Math.max(W, Math.min(P, E)), j.autoHeight && "iframe" !== j.type && (T.width(P), _ = T.height()), _ = Math.max(L, Math.min(_, M))), j.fitToView)if (T.width(P).height(_), O.width(P + e), p = O.width(), h = O.height(), j.aspectRatio)for (; (p > u || h > y) && P > W && _ > L && !(x++ > 19);)_ = Math.max(L, Math.min(M, _ - 10)), P = g(_ * d), P < W && (P = W, _ = g(P / d)), P > E && (P = E, _ = g(P / d)), T.width(P).height(_), O.width(P + e), p = O.width(), h = O.height(); else P = Math.max(W, Math.min(P, P - (p - u))), _ = Math.max(L, Math.min(_, _ - (h - y)));
            R && "auto" === H && _ < r && P + e + R < u && (P += R), T.width(P).height(_), O.width(P + e), p = O.width(), h = O.height(), k = (p > u || h > y) && P > W && _ > L, C = j.aspectRatio ? P < l && _ < c && P < a && _ < r : (P < l || _ < c) && (P < a || _ < r), i.extend(j, {
                dim: {
                    width: m(p),
                    height: m(h)
                },
            ...
            }), !b && j.autoHeight && _ > L && _ < M && !C && T.height("auto")
        },
        ...
        beforeShow: function (e, t) {
            t.locked && !this.el.hasClass("fancybox-lock") && (this.fixPosition !== !1 && i("*:not(object)").filter(function () {
    ...
    t.helpers.buttons = {
        defaults: {
            ...
            var o = this.buttons;
            o || (this.list = e(i.tpl).addClass(i.position).appendTo("body"), o = {
    ...
    t.helpers.media = {
        defaults: {
            ...
            var o, a, r, s, l = n.href || "", c = !1;
            for (o in t)if (t.hasOwnProperty(o) && (a = t[o], r = l.match(a.matcher))) {
                c = a.type, s = e.extend(!0, {}, a.params, n[o] || (e.isPlainObject(t[o]) ? t[o].params : null)), l = "function" === e.type(a.url) ? a.url.call(this, r, s, n) : i(a.url, r, s);
                break
            }
    ...
    t.helpers.thumbs = {
        defaults: {
            ...
            var n, o = this, a = t.width, r = t.height, s = t.source;
            n = "";
            for (var l = 0; l < i.group.length; l++)n += '<li><a style="width:' + a + "px;height:" + r + 'px;" href="javascript:jQuery.fancybox.jumpto(' + l + ');"></a></li>';
            this.wrap = e('<div id="fancybox-thumbs"></div>').addClass(t.position).appendTo("body"), this.list = e("<ul>" + n + "</ul>").appendTo(this.wrap), e.each(i.group, function (t) {
                var n = i.group[t], l = s(n);
                l && e("<img />").on("load", function () {
                    var i, n, s, l = this.width, c = this.height;
                    o.list && l && c && (i = l / a, n = c / r, s = o.list.children().eq(t).find("a"), i >= 1 && n >= 1 && (i > n ? (l = Math.floor(l / n), c = r) : (l = a, c = Math.floor(c / i))), e(this).css({
                        width: l,
                        height: c,
                        top: Math.floor(r / 2 - c / 2),
                        left: Math.floor(a / 2 - l / 2)
                    }), s.width(a).height(r), e(this).hide().appendTo(s).fadeIn(300))
                }).attr("src", l).attr("title", n.title)
