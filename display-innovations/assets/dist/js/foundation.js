...
!function (t) {
        ...
        version: s, _plugins: {}, _uuids: [], rtl: function () {
            ...
            try {
                if (i)e.each(function () {
                    ...
                    var s = "undefined" == typeof e ? "undefined" : _typeof(e), o = this, a = {
                        object: function (e) {
    ...
    var a = function (i) {
        var n = "undefined" == typeof i ? "undefined" : _typeof(i), s = t("meta.foundation-mq"), a = t(".no-js");
        ...
        return _createClass(e, [{
            key: "_init", value: function () {
                ...
                this.firstTimeInit = !0, i.length && (this.down(i, this.firstTimeInit), this.firstTimeInit = !1), this._checkDeepLink = function () {
                    ...
                    if (i.length) {
                        var n = e.$element.find('[href$="' + i + '"]'), s = t(i);
                        if (n.length && s) {
                            if (n.parent("[data-accordion-item]").hasClass("is-active") || (e.down(s, e.firstTimeInit), e.firstTimeInit = !1), e.options.deepLinkSmudge) {
                                ...
                                t(window).load(function () {
                                    ...
                                    t("html, body").animate({scrollTop: e.top}, o.options.deepLinkSmudgeDelay)
                                })
                            }
    ...
    var e = function () {
        ...
        return _createClass(e, [{
            ...
            key: "_show", value: function (t) {
                this.options.autoHeight && this.$wrapper.css({height: t.children("[data-submenu]").data("calcHeight")}), t.attr("aria-expanded", !0), t.children("[data-submenu]").addClass("is-active").attr("aria-hidden", !1),
            ...
            key: "_events", value: function () {
                ...
                (this.options.clickOpen || i) && this.$menuItems.on("click.zf.dropdownmenu touchstart.zf.dropdownmenu", s), e.options.closeOnClickInside && this.$menuItems.on("click.zf.dropdownmenu", function (i) {
                    ...
                    a ? e._isVertical() ? Foundation.rtl() ? t.extend(c, {
                        ...
                        next: u,
                        previous: d
                    }) : t.extend(c, {down: l, up: h, next: d, previous: u}) : Foundation.rtl() ? t.extend(c, {
                        next: h,
                        previous: l,
                        down: d,
                        up: u
                    }) : t.extend(c, {next: l, previous: h, down: d, up: u}) : Foundation.rtl() ? t.extend(c, {
                        next: u,
                        previous: d,
                        down: l,
                        up: h
        ...
        return _createClass(s, [{
            ...
            key: "_setHandlePos", value: function (t, i, n, s) {
                if (!this.$element.hasClass(this.options.disabledClass)) {
                    ...
                    var l = this, h = this.options.vertical, d = h ? "height" : "width", u = h ? "top" : "left", c = t[0].getBoundingClientRect()[d], f = this.$element[0].getBoundingClientRect()[d], p = this._pctOfBar(i), m = (f - c) * p, g = (100 * e(m, f)).toFixed(this.options.decimal);
                    ...
                    Foundation.Move(C, t, function () {
                        isNaN(g) ? t.css(u, 100 * p + "%") : t.css(u, g + "%"), l.options.doubleSided ? l.$fill.css(v) : l.$fill.css(d, 100 * p + "%")
            ...
            key: "_handleEvent", value: function (n, s, o) {
                ...
                if (o)a = this._adjustValue(null, o), r = !0; else {
                    ...
                    if (a = this._value(y), Foundation.rtl() && !this.options.vertical && (a = this.options.end - a), a = l._adjustValue(null, a), r = !1, !s) {
                        var w = i(this.$handle, u, g, d), b = i(this.$handle2, u, g, d);
