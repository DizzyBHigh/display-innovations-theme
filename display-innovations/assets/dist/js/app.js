jQuery(document).ready(function (e) {
    e(document).foundation(), e(".fancybox").attr("rel", "gallery").fancybox({
        openEffect: "none",
        closeEffect: "none",
        nextEffect: "none",
        prevEffect: "none",
        ...
        preLoad: 3,
        beforeLoad: function () {
            var t, n = e(this.element).data("title-id");
            n && (t = e("#" + n), t.length && (this.title = t.html() + "<br><i>Image " + (this.index + 1) + " of " + this.group.length + "</i>"))
        },
