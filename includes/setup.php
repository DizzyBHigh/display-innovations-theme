...
add_action( 'after_setup_theme',
	function () {
		 ...
		 * to change 'display-innovations' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'display-innovations', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background',
			apply_filters( 'heisenberg_custom_background_args',
				array(
